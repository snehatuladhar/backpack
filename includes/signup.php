								...
								<div class="modal-body modal-spa">
									<div class="login-grids">
										<div class="login-left">
											<ul>
												<li>1.Please include every information mentioned.</li>
												<li>2.Please do keep the details correctly.</li>
												<li>3.If wrong information are fetched action are taken into consideration.</li>
											</ul>
										</div>
